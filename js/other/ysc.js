...
(function (window,undefined) {
    ...
    function creatBrokenLine(viewer,data) {
        if(data.flowing==true){
            ...
            var color=data.options.polyline.material[0];
            var duration=data.options.polyline.material[1];
            data.options.polyline.material=new Cesium.PolylineTrailLinkMaterialProperty(color,duration);
        }
    ...
    function creatWall(viewer,data) {
        if(data.flowing==true){
            initPolylineTrailLinkMaterialProperty(data);
            var color=data.options.wall.material[0];
            var duration=data.options.wall.material[1];
            data.options.wall.material=new Cesium.PolylineTrailLinkMaterialProperty(color,duration);
        }
        viewer.entities.add(data.options);
    }
